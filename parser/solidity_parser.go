...
func solidityParserInit() {
	...
	staticData.serializedATN = []int32{
		...
		117, 117, 124, 125, 127, 128, 1297, 0, 214, 1, 0, 0, 0, 2, 219, 1, 0, 0,
...
func (p *SolidityParser) SourceUnit() (localctx ISourceUnitContext) {
	...
	for ((int64((_la-1)) & ^0x3f) == 0 && ((int64(1)<<(_la-1))&-2305234807432531967) != 0) || ((int64((_la-65)) & ^0x3f) == 0 && ((int64(1)<<(_la-65))&-427560355405758461) != 0) {
		p.SetState(212)
		p.GetErrorHandler().Sync(p)
		if p.HasError() {
			goto errorExit
